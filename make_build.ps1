Write-Debug "Make Build for Dodo Paradize"

$build_name = "dodo-paradize-build"
...
(Get-Content ("../" + $build_name + "/game.js")).Replace('this.DEBUG_MODE = true', 'this.DEBUG_MODE = false') | Set-Content ("../" + $build_name + "/game.js")
(Get-Content ("../" + $build_name + "/game.js")).Replace('this.DEBUG_USE_LOCAL_STORAGE = true', 'this.DEBUG_USE_LOCAL_STORAGE = false') | Set-Content ("../" + $build_name + "/game.js")